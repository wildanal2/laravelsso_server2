...
<script>
    function destroy(id, name) {
        Swal.fire({
            title: 'Are you sure to Delete Oauth Client?',
            text: 'You will Oauth Client `' + name + '`',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: "#DC3741",
            confirmButtonText: 'Delete Oauth Client',
    ...
    $(document).ready(function() {
        var main_table = $('#main-table').DataTable({
            ...
            columns: [{
                ...
                className: 'text-center',
                render: (data) => {
                    return data.revoked ? '<span class="badge bg-danger">Revoked</span>' : '<span class="badge bg-success">False</span>';
                }
            }, {
                title: 'Aksi',
                data: 'id',
            ...
            "fnDrawCallback": function() {
                ...
                $('.btn-oauth-destroy').on('click', function() {
                    var id = $(this).data('id');
